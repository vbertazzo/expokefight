...
config :expokefight, ExpokefightWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: ExpokefightWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Expokefight.PubSub,
  live_view: [signing_salt: "0tHw+hpY"]
...
# Use Hackney as Tesla's adapter
